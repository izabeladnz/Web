...
<html><head>
		<div class="conteudo">
			...
			<p><input type="button" href="form-addfornecedores.php" onclick="chama(this)" value="Adicionar Fornecedor"></input></p>
			...
			<p>Total de Fornecedores: <?php echo $total ?></p>
				...
				<tr>
					...
					<td>
					<input type="button" href="form-editfornecedores.php?id=<?php echo $fornecedor['idFornecedor']?>" onclick="chama(this)" value="Editar"></input>
					<input type="button" onclick="chama(this)" href="deletefornecedores.php?id=<?php echo $fornecedor['idFornecedor'] ?>" value="Excluir"> </input>
					</td>
				</tr>
				 <?php endwhile; ?>
 				</tbody>
