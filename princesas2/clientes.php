...
<html><head>
		<div class="conteudo">
			...
			<p><input type="button" href="form-addclientes.php" onclick="chama(this)" value="Adicionar Cliente"></input></p>
			...
			<p>Total de Clientes: <?php echo $total ?></p>
				...
				<tr>
					...
					<td>
					<input type="button" href="form-editclientes.php?id=<?php echo $cliente['idCliente']?>" onclick="chama(this)" value="Editar"></input>
					<input type="button" onclick="chama(this)" href="deleteclientes.php?id=<?php echo $cliente['idCliente'] ?>" value="Excluir"> </input>
					</td>
				</tr>
				 <?php endwhile; ?>
 				</tbody>
